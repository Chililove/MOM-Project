...
<body>
    <div style="display:flex; justify-content:center; align-items: center;">
        ...
        <a href="./reg/agendapoint_page.asp?action=newpoint?id=<%=id_agenda%>"><button>Add agendapoints to selected meeting</button></a>

    </div>

"reg/agendapoint_page.asp?action=newpoint"
    <%

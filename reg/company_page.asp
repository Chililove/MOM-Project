...
If Len(Request.QueryString("id_company")) > 0 Then
    ...
    id_company = Trim(Request.QueryString("id_company"))

    If IsNumeric(id_company) Then
        ' SQL to get company details by id_company
        sql = "SELECT * FROM tbl_companies WHERE id_company = " & id_company
    ...
    End If
Else
    ' If there is no id_company in the query string, we are creating a new company
...
<!--#include file="../reg/companies_form.asp"-->			

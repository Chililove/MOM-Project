...
elseif request("action")="ret" then
    ...
    response.write id_logintype & "(id_logintype)<br>"
    response.write login & "(login)<br>"
    response.write fornavn & "(fornavn)<br>"
    response.write efternavn & "(efternavn)<br>"
    response.write mailadresse & "(mailadresse)<br>"
    response.write password1 & "(password1)<br>"
    response.write id_company & "(id_company)<br>"
    response.write id_login & "(id_login)<br>"

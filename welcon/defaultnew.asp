...
//******************************************
	function editInfo(id){
		...
		theInfo=document.getElementById(selectedINFO).innerHTML
		theInfo = theInfo.split("<br>").join("\n")			
		document.getElementById("theInfo").value=theInfo
...
%>
<div id="div1" style="width:<%=width%>px;border:solid 1px #808080;border-bottom:none;overflow:scroll" onscroll="ScrollIt(this.id)">
...
%>		
	...
	<tr>
		...
		<td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;width:282px"  bgcolor="#eeeeee"><b>INFO</b></td>
...
<div id="div2" style="width:<%=width%>px;height:300px;border:solid 1px #808080;border-top:none;overflow:scroll" onscroll="ScrollIt(this.id)">
<table width="100%" border="0" cellpadding="2" cellspacing="0" style="table-layout:fixed;border:solid 1px #000000" >
